...
#define TRTTI_MALLOC(sz) TJSON_MALLOC(sz)
#define TRTTI_CALLOC(n, sz) ERROR_DONT_USE_CALLOC_TRC
#define TRTTI_REALLOC(p, sz) ERROR_DONT_USE_REALLOC_TRC
#define TRTTI_FREE(p) TJSON_FREE(p)
